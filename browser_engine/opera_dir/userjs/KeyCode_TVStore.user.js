// ==UserScript==
// @name Opera TVStore html5
// @description for TVStore keyCode map.
// @match http://team.opera.com/*
// @match https://*.opera.com/*
// @match https://team.opera.com/*
// @match https://*.tvstore.opera.com/*
// @match http://*.tvstore.opera.com/*
// @match http://test.me.sel.sony.com/ceb/crackle*
// @run-at document-start
// ==/UserScript==
	console.log("tv store userjs");
    	console.log("tv store key definition");
    ...
    window.VK_GREEN = 404;
    window.VK_MENU = 462;
    console.log("TVStore userjs VK_PLAY415 = " + VK_PLAY);
